...
Report bugs and errors using GitHub [issues](https://github.com/infobip/xk6-infobip-mcp/issues).
...
Feature requests are managed as GitHub [issues](https://github.com/infobip/xk6-infobip-mcp/issues).

Before submitting a new suggestion:

* Ensure you are using the latest version.  
* Carefully review the documentation to see if the functionality already exists.  
* Search existing [issues](https://github.com/infobip/xk6-infobip-mcp/issues) to avoid duplicates and add a comment if your idea is already present.  
...
1. Check existing [issues](https://github.com/infobip/xk6-infobip-mcp/issues) or create a new one to discuss your intended fix or feature.  
...
```bash
xk6 build --with xk6-infobip-mcp=.
```
...
Use [mdcode] tool to update the infobip_mcp code blocks in `README.md`
